...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String BENEFICIARY_FIRST_NAME= "sender_first_name";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String CREATE_RAPPORT_TABLE = "CREATE TABLE " + TABLE_TRANSFER_REQUESTS  + "("
        ...
        String CREATE_TABLE_MESSAGES_OPERATUER = "CREATE TABLE " + TABLE_WITHDRAWAL_REQUESTS  + "("
    ...
    public void addRequestData(RequestData requestData){
        ...
        contentValues.put(BENEFICIARY_LAST_NAME, requestData.getSenderLastName());
        contentValues.put(BENEFICIARY_FIRST_NAME, requestData.getSenderFirstname());
        contentValues.put(BENEFICIARY_PHONE, requestData.getSenderPhone());
    ...
    public List<RequestData> getRequestData(){
        ...
        while (cursor.moveToNext()) {
            ...
            String senderFirstName = cursor.getString(cursor.getColumnIndex(SENDER_LAST_NAME));
