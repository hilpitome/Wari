...
public class WithdrawRequestFragment extends Fragment {
    ...
    List<WithdrawalData> records;
    WithdrawalRequestAdapter withdrawalRequestAdapter;
    ...
    private void intitalizeView(View view) {
        ...
        if(records.size()<1){
            ...
            withdrawalRequestAdapter = new WithdrawalRequestAdapter(getActivity(), records);

            recyclerView.setAdapter(withdrawalRequestAdapter);
